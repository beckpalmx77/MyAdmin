...
foreach ($empRecords as $row) {
    ...
    $data[] = array(
        ...
        "select" => "<button type='button' name='select' id='" . $row['unit_id'] . "@" . $row['unit_name'] . "' class='btn btn-outline-success btn-xs select' data-toggle='tooltip' title='select'>select</button>",
    );
